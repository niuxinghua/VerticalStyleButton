...
- (void)addTimer{
    self.timer = [NSTimer scheduledTimerWithTimeInterval:10.0 target:self selector:@selector(changePage) userInfo:nil repeats:YES];
...
- (UIScrollView *)bannerScrollView{
    if (!_bannerScrollView) {
        ...
        _bannerScrollView = [[UIScrollView alloc] init];
         //_bannerScrollView.alwaysBounceVertical = NO;
